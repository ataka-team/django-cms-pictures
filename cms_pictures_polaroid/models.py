...
class Polaroid(CMSPlugin):
    """
    A Polaroid with or without a link
    """
    CENTER = "center"
    LEFT = "left"
    RIGHT = "right"
    ...
    angle = models.CharField(_("rotation angle"), max_length=255, blank=True, null=True, help_text=_("rotation angle of the image"))
